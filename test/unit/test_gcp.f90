...
subroutine collect_gcp(testsuite)
   ...
   testsuite = [ &
      ...
      & new_unittest("hess:hf/dz", test_hf_dz_hess), &
      & new_unittest("hess:hf/minix", test_hf_minix_hess), &
      & new_unittest("hess:dft/lanl2", test_dft_lanl2_hess), &
      & new_unittest("hess:hf3c", test_hf3c_hess), &
      & new_unittest("hess:pbeh3c", test_pbeh3c_hess), &
      & new_unittest("hess:hse3c", test_hse3c_hess), &
      & new_unittest("hess:b973c", test_b973c_hess), &
      & new_unittest("hess:r2scan3c", test_r2scan3c_hess), &
      & new_unittest("hess:pbc:hf3c", test_hf3c_pbc_hess), &
...
subroutine test_numhess(error, mol, method, basis)
   ...
   real(wp), allocatable :: gradient(:, :), gradp(:, :), gradm(:, :), xyz(:, :)
   ...
   allocate(gradient(3, mol%nat), gradp(3, mol%nat), gradm(3, mol%nat), &
      & xyz(3, mol%nat), hessian(3*mol%nat, 3*mol%nat), &
