program pbc_smooth
   ...
   ! the widths switch the pair contributions off over the last 0.05 Bohr
   ! before the respective cutoff
   call get_dispersion(mol, disp, param, &
      & realspace_cutoff(width2=0.05_r8, width3=0.05_r8), energy)

   print "(3a, f13.10, a)", "Dispersion energy for ", method, "-D3(BJ) is ", energy, " Hartree"

end program pbc_smooth
